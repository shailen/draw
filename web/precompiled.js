...
// Native classes
// Bound closures
$$.Bound__completeError__Future = [P, {"": "BoundClosure;_self,_liblib$_target,_receiver,_liblib$_name",
  call$2: function(p0, p1) {
    return this._liblib$_target.call(this._self, p0, p1);
  },
...
$$.Bound__run__ZoneTimer = [P, {"": "BoundClosure;_self,_liblib$_target,_receiver,_liblib$_name",
  call$0: function() {
    return this._liblib$_target.call(this._self);
  },
  $is_void_: true
}];

$$.BoundClosure$1 = [G, {"": "BoundClosure;_self,_liblib$_target,_receiver,_liblib$_name",
  call$1: function(p0) {
    return this._liblib$_target.call(this._self, p0);
  }
}];

$$.Bound_setCanvasSize_Doodle = [G, {"": "BoundClosure;_self,_liblib$_target,_receiver,_liblib$_name",
  call$1: function(p0) {
    return this._liblib$_target.call(this._self, p0);
  },
  call$0: function() {
...
BoundClosure: {"": "Closure;_self,_liblib$_target,_receiver,_liblib$_name",
  $eq: function(_, other) {
    var t1;
    if (other == null)
      return false;
  ...
  get$hashCode: function(_) {
    ...
    return (receiverHashCode ^ H.Primitives_objectHashCode(this._liblib$_target)) >>> 0;
  },
  $isBoundClosure: true
},
...
MouseEvent: {"": "UIEvent;_clientX:clientX=,_clientY:clientY=",
  get$client: function(receiver) {
...
UIEvent: {"": "Event;_layerX:layerX=,_layerY:layerY=",
  get$layer: function(receiver) {
    return new W.Point(receiver.layerX, receiver.layerY);
  }
},
...
FEBlendElement: {"": "SvgElement;width="},

FEColorMatrixElement: {"": "SvgElement;width="},

FEComponentTransferElement: {"": "SvgElement;width="},

FECompositeElement: {"": "SvgElement;width="},

FEConvolveMatrixElement: {"": "SvgElement;width="},

FEDiffuseLightingElement: {"": "SvgElement;width="},

FEDisplacementMapElement: {"": "SvgElement;width="},

FEFloodElement: {"": "SvgElement;width="},

FEGaussianBlurElement: {"": "SvgElement;width="},

FEImageElement: {"": "SvgElement;width="},

FEMergeElement: {"": "SvgElement;width="},

FEMorphologyElement: {"": "SvgElement;width="},

FEOffsetElement: {"": "SvgElement;width="},

FESpecularLightingElement: {"": "SvgElement;width="},

FETileElement: {"": "SvgElement;width="},

FETurbulenceElement: {"": "SvgElement;width="},

FilterElement: {"": "SvgElement;width="},

ForeignObjectElement: {"": "GraphicsElement;width="},

GraphicsElement: {"": "SvgElement;"},

ImageElement0: {"": "GraphicsElement;width="},

MaskElement: {"": "SvgElement;width="},

PatternElement: {"": "SvgElement;width="},

RectElement: {"": "GraphicsElement;width="},

SvgElement: {"": "Element;"},

SvgSvgElement: {"": "GraphicsElement;width="},

UseElement: {"": "GraphicsElement;width="}}],
...
["doodle.dart", "doodle.dart", , G, {
main: function() {
  G.Doodle$(document.querySelector("canvas")).begin$0();
},

Doodle: {"": "Object;canvas,ctx,lastX,lastY,nextX,nextY,draw,subscription",
  frame$1: function(t) {
    C.Window_methods.get$animationFrame(window).then$1(this.get$frame());
    this.drawLine$0();
  },
  get$frame: function() {
    return new G.BoundClosure$1(this, G.Doodle.prototype.frame$1, null, "frame$1");
  },
  windowToCanvas$1: function(x) {
    var t1, bbox, t2, t3;
    t1 = this.canvas;
    bbox = t1.getBoundingClientRect();
    t2 = J.getInterceptor$x(bbox);
    t3 = t2.get$left(bbox);
    t1 = J.get$width$x(t1);
  ...
  setCanvasSize$1: function(e) {
    ...
    t2.set$height(t1, document.body.offsetHeight);
  },
  setCanvasSize$0: function() {
    return this.setCanvasSize$1(null);
  },
  get$setCanvasSize: function() {
    return new G.Bound_setCanvasSize_Doodle(this, G.Doodle.prototype.setCanvasSize$1, null, "setCanvasSize$1");
  },
  begin$0: function() {
    var t1, t2, t3;
    ...
    t2 = this.canvas;
    t2.get$onMouseDown;
    t1 = new W._ElementEventStreamImpl(t2, C.EventStreamProvider_mousedown._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t3 = this.get$mouseClickCallback();
    t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, t3, t1._useCapture);
    ...
    t3 = this.get$touchStartCallback();
  ...
  mouseClickCallback$1: function(e) {
    ...
    this.nextX = t2;
    this.lastX = t2;
    t1 = this.windowToCanvas$1(new W.Point(t1.get$_clientX(e), t1.get$_clientY(e)).y);
    this.nextY = t1;
    this.lastY = t1;
    t1 = this.canvas;
    t1.get$onMouseMove;
  ...
  get$mouseClickCallback: function() {
    return new G.BoundClosure$1(this, G.Doodle.prototype.mouseClickCallback$1, null, "mouseClickCallback$1");
  },
  touchStartCallback$1: function(e) {
    var t1, t2, t3;
    H.Primitives_printString("in touchStart");
    t1 = J.getInterceptor$x(e);
    t1.preventDefault$0(e);
    t1.stopPropagation$0(e);
    ...
    this.nextX = t2;
    this.lastX = t2;
    t1 = this.windowToCanvas$1(new W.Point(t1.get$_layerX(e), t1.get$_layerY(e)).y);
    this.nextY = t1;
    this.lastY = t1;
    t1 = this.canvas;
    t1.get$onTouchMove;
    t2 = new W._ElementEventStreamImpl(t1, C.EventStreamProvider_touchmove._eventType, false);
    H.setRuntimeTypeInfo(t2, [null]);
  ...
  get$touchStartCallback: function() {
    return new G.BoundClosure$1(this, G.Doodle.prototype.touchStartCallback$1, null, "touchStartCallback$1");
  },
  mouseMoveCallback$1: function(e) {
    ...
    this.nextY = this.windowToCanvas$1(new W.Point(t1.get$_clientX(e), t1.get$_clientY(e)).y);
  },
  get$mouseMoveCallback: function() {
    return new G.BoundClosure$1(this, G.Doodle.prototype.mouseMoveCallback$1, null, "mouseMoveCallback$1");
  },
  touchMove$1: function(e) {
    var t1;
    H.Primitives_printString("in touchMove");
    t1 = J.getInterceptor$x(e);
    t1.preventDefault$0(e);
    t1.stopPropagation$0(e);
    this.nextX = this.windowToCanvas$1(t1.get$layer(e).x);
    this.nextY = this.windowToCanvas$1(new W.Point(t1.get$_layerX(e), t1.get$_layerY(e)).y);
  },
  get$touchMove: function() {
    return new G.BoundClosure$1(this, G.Doodle.prototype.touchMove$1, null, "touchMove$1");
  },
  ...
  get$mouseUpCallback: function() {
    return new G.BoundClosure$1(this, G.Doodle.prototype.mouseUpCallback$1, null, "mouseUpCallback$1");
  },
  touchEnd$1: function(e) {
    var t1;
    H.Primitives_printString("in touchEnd");
    t1 = J.getInterceptor$x(e);
    t1.preventDefault$0(e);
    t1.stopPropagation$0(e);
    this.subscription.cancel$0();
  ...
  get$touchEnd: function() {
    return new G.BoundClosure$1(this, G.Doodle.prototype.touchEnd$1, null, "touchEnd$1");
  },
  drawLine$0: function() {
    if (!this.draw)
      return;
    this._drawLine$4(this.lastX, this.lastY, this.nextX, this.nextY);
    this.lastX = this.nextX;
    this.lastY = this.nextY;
  },
  _drawLine$4: function(lastX, lastY, nextX, nextY) {
    J.beginPath$0$x(this.ctx);
    J.moveTo$2$x(this.ctx, lastX, lastY);
    J.lineTo$2$x(this.ctx, nextX, nextY);
  ...
  Doodle$1: function(canvas) {
    ...
    J.set$lineWidth$x(this.ctx, 6);
    J.set$lineCap$x(this.ctx, "round");
    J.set$strokeStyle$x(this.ctx, "rgb(250,250, 125)");
    C.Window_methods.get$animationFrame(window).then$1(this.get$frame());
  },
  static: {
Doodle$: function(canvas) {
  var t1 = new G.Doodle(canvas, null, null, null, null, null, false, null);
  t1.Doodle$1(canvas);
  return t1;
}}
...
function dart_precompiled($collectedClasses) {
  ...
  function BoundClosure(_self, _liblib$_target, _receiver, _liblib$_name) {
    this._self = _self;
  ...
  function Bound__completeError__Future(_self, _liblib$_target, _receiver, _liblib$_name) {
    this._self = _self;
    this._liblib$_target = _liblib$_target;
    this._receiver = _receiver;
    this._liblib$_name = _liblib$_name;
  ...
  function Bound__run__ZoneTimer(_self, _liblib$_target, _receiver, _liblib$_name) {
    this._self = _self;
    this._liblib$_target = _liblib$_target;
    this._receiver = _receiver;
    this._liblib$_name = _liblib$_name;
  ...
  function Doodle(canvas, ctx, lastX, lastY, nextX, nextY, draw, subscription) {
    this.canvas = canvas;
    this.ctx = ctx;
    this.lastX = lastX;
    this.lastY = lastY;
  ...
  Doodle.builtin$cls = "Doodle";
  if (!"name" in Doodle)
    Doodle.name = "Doodle";
  $desc = $collectedClasses.Doodle;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Doodle.prototype = $desc;
  function BoundClosure$1(_self, _liblib$_target, _receiver, _liblib$_name) {
    this._self = _self;
    this._liblib$_target = _liblib$_target;
    this._receiver = _receiver;
    this._liblib$_name = _liblib$_name;
  ...
  function Bound_setCanvasSize_Doodle(_self, _liblib$_target, _receiver, _liblib$_name) {
    this._self = _self;
    this._liblib$_target = _liblib$_target;
    this._receiver = _receiver;
    this._liblib$_name = _liblib$_name;
  }
  Bound_setCanvasSize_Doodle.builtin$cls = "Bound_setCanvasSize_Doodle";
  $desc = $collectedClasses.Bound_setCanvasSize_Doodle;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Bound_setCanvasSize_Doodle.prototype = $desc;
